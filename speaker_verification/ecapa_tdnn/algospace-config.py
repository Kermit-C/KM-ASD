...
name = 'speaker_verification_cn1'
version = 'v1.4'
secret = ""
service_filepath = "./app.py"
service_function = 'WrappedSpeakerVerification'
service_input = {
    'path1': {
        'type': 'voice_path',
        'describe': '说话人1',
...
description = '''这是<a href="http://iir.ruc.edu.cn">DBIIR实验室</a>多模态信息处理研究组的声纹验证（说话人确认）演示。
<br>
<b>研发团队：</b>
<br>
<li>薛松岩：信息学院2022届硕士毕业生，现为四川省遂宁市组织部选调生；</li>
<li><a href="/user/fsx">范胜旭</a>：信息学院2020级硕士生；</li>
<li>罗茂峰：西蒙电气公司高级工程师，信息学院在职硕士研究生。</li>'''
scope = 'PUBLIC'
chinese_name = '声纹验证'
document_filepath = ''
...
gradio_launch_filepath = "./app.py"
gradio_launch_function = 'launch_gradio'
gradio_launch_host = '127.0.0.1'
gradio_launch_port = 7880
